...
/* harmony import */ var app_shared_services_auth_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! app/shared/services/auth.service */ "./src/app/shared/services/auth.service.ts");
/* harmony import */ var _mirapi_components_navigation_navigation_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @mirapi/components/navigation/navigation.service */ "./src/@mirapi/components/navigation/navigation.service.ts");
...
let DashboardComponent = class DashboardComponent {
    constructor(authService, mirapiNavigationService, httpRequestService, router) {
    ...
    setNavigations() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.navigation = yield this.removeUnauthorizedUrlsFromNavigation(this.navigation);
            this.mirapiNavigationService.unregister('main');
            this.navigation = this.mirapiNavigationService.register('main', this.navigation.slice());
            // Set the main navigation as our current navigation
            this.mirapiNavigationService.setCurrentNavigation('main');
        });
    }
    removeUnauthorizedUrlsFromNavigation(array) {
...
DashboardComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./dashboard.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/main/dashboard/dashboard.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./dashboard.component.scss */ "./src/app/main/dashboard/dashboard.component.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [app_shared_services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"],
        _mirapi_components_navigation_navigation_service__WEBPACK_IMPORTED_MODULE_3__["MirapiNavigationService"],
        app_shared_services_httpRequests_service__WEBPACK_IMPORTED_MODULE_4__["HttpRequestsService"],
...
/* harmony import */ var enums_pageTypes_enum__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! enums/pageTypes.enum */ "./src/enums/pageTypes.enum.ts");
/* harmony import */ var app_shared_guards_login_guard__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! app/shared/guards/login.guard */ "./src/app/shared/guards/login.guard.ts");
...
const routes = [
    {
        ...
        data: { pageType: enums_pageTypes_enum__WEBPACK_IMPORTED_MODULE_10__["PageClaims"].dashboard }
    }
];
